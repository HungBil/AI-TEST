...
import { MODULE_LABELS, DISCLAIMER, EXAM_BLUEPRINTS } from './shared.mjs';
...
function buildExam(blueprint) {
  ...
  const questions = [
    ...buildModuleA(examNo, blueprint),
    ...buildModuleB(examNo, blueprint),
    ...buildModuleC(examNo, blueprint),
    ...buildModuleD(examNo, blueprint)
  ];
  return {
    ...
    moduleOverview: [
      ...
      'Module 3 · C: 12 câu ML cơ bản, confusion matrix/SVM/backprop/RAG theo trọng tâm từng đề; gồm đúng 3 câu tự luận có ràng buộc.',
      'Module 4 · D: 8 câu tình huống đạo đức AI, banking, privacy và phân quyền dữ liệu.'
    ],
    coverageProfile: {
      title: blueprint.title,
      sfiaOrientation: 'Readiness from Level 3 Apply toward Level 4 Enable; not an official SFIA assessment',
